    ...
    def get_mean_std(self):
        ...
        if not os.path.isfile(mean_std_cache):
            ...
            for i, data in enumerate(self):
                ...
                # print("-----------data:", data['mesh'].filename, features.mean(axis=1))
                # print("features:", features.shape, features)
                # print("features.max(axis=1):", features.max(axis=1))
                # indices = np.where(features > 5)
            ...
            print('saved  --- mean, std: ', mean_std_cache, mean, std)
