...
class BaseOptions:
    ...
    def initialize(self):
        # data params
        self.parser.add_argument('--dataroot', default="/home/zxk/code/P2ILF-Mesh/Ours-ablation-3-L/datasets/All_data", help='path to meshes (should have subfolders train, test)')
        self.parser.add_argument('--dataset_mode', choices={"classification", "segmentation"}, default='segmentation')
        self.parser.add_argument('--ninput_edges', type=int, default=22000, help='# of input edges (will include dummy edges)')
        ...
        self.parser.add_argument('--ncf', nargs='+', default=[16, 32, 64, 128, 128], type=int, help='conv filters')
        self.parser.add_argument('--pool_res', nargs='+', default=[22000, 3000, 2250, 1750], type=int, help='pooling res')
        self.parser.add_argument('--norm', type=str, default='instance',help='instance normalization or batch normalization or group normalization')
        ...
        self.parser.add_argument('--seed', type=int, default=2024, help='if specified, uses seed')
