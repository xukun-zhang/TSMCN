...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--continue_train', action='store_true', help='continue training: load the latest model', default=False)
        ...
        self.parser.add_argument('--num_aug', type=int, default=50, help='# of augmentation files')
        self.parser.add_argument('--scale_verts', default=True, help='non-uniformly scale the mesh e.g., in x, y or z')
